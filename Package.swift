...
let package = Package(
    ...
    dependencies: [
      ...
      .package(url: "https://github.com/sparrowcode/PermissionsKit", .upToNextMajor(from: "11.0.1")),
      ...
      .package(url: "https://github.com/sereivoanyong/SVProgressHUD.git", branch: "main"),
