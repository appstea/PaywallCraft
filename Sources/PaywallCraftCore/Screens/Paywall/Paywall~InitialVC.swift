...
extension Paywall {
  ...
  final class InitialVC: ViewController {
    ...
    fileprivate lazy var closeButtonView = UIBase.Button()
    ...
    override func loadView() {
      ...
      view.addSubviews(contentView, closeButtonView, closeButton)
    ...
    override func viewDidLoad() {
      ...
      closeButtonView.addAction { [weak self] _ in
    ...
    override func viewDidLayoutSubviews() {
      ...
      closeButtonView.pin.horizontally().top().bottom(to: closeButton.edge.bottom)
